...
<!-- Navbar -->
<nav class="bg-red-600  w-full z-50 px-6 py-4 text-white" id="nav">
...
<ul>
    <li><a href="http://sewakaset.test/" class="block hover:text-yellow-500">Dashboard</a></li>
    <li> <a href="#" class="block hover:text-yellow-500">Produk</a></li>
    <li> <a onclick="keranjang()" class="block hover:text-yellow-500 cursor-pointer">Keranjang</a></li>
    <li>    <a href="#" class="block hover:text-yellow-500">Riwayat Transaksi</a></l></li>
